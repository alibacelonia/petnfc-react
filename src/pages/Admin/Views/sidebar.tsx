...
import { HiOutlineQrCode, HiOutlineUserGroup } from "react-icons/hi2";
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { id: 2, name: "Users", icon: HiOutlineUserGroup },
  { id: 3, name: "Orders", icon: RiShoppingCartLine },
  { id: 3, name: "Feedbacks", icon: FiMessageSquare },
  { id: 4, name: "Profile", icon: FiUser },
