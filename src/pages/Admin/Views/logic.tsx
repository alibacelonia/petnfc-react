...
import { PageAction, PageActionPayload } from "../../../flux/navigation/types";
...
export const useLogic = () => {
  ...
  const [currentPage, setPage] = useState("admin_home");
  const [previousPageInfo, setPreviousPageInfo] = useState<PageAction | null>(null);
  ...
  const pageStateHistory = pageState.history;
  ...
  useEffect(() => {
    ...
    if (pageState.selectedPage !== undefined) {
      ...
      localStorage.setItem("currentPage", selectedPage == "home" ? "admin_home" : selectedPage);
      localStorage.setItem("pageData", JSON.stringify(pageData));
      // Update the page state
      setPage(selectedPage == "home" ? "admin_home" : selectedPage);
    }
    setReady(true);
  }, [pageState]);
  ...
  return { currentPage, previousPageInfo };
};
